...
# 🔗 Live demo: design-loop-three.vercel.app
...
# ✨ Features
_ 📋 3 real LLD problems with proper requirements + constraints, not toy examples
_ ✍️ Submit a design rationale + code/pseudocode stubs
_ ✅🤖 Feedback split between deterministic checks and AI judgment, clearly tagged
_ 💬 A few "worth thinking about" follow-up questions on every submission, not just a score, something to chew on
_ 🔁 Resubmit as many times as you want under the same attempt, and watch your scores actually move
_ 📊 Full history across every problem you've tried
_ 🛟 If the AI call fails or times out, you still get your deterministic feedback, never a blank screen
